...
export default ({body, week_name}: LadderProps) => {
    return <div className={'weekly-ladder-result'}>
        ...
        <Grid columns="equal" textAlign={"center"}>
            <Grid.Column textAlign={"center"}>
                <Table celled inverted compact size={"small"}
                    ...
                    <Table.Header>
                        <Table.Row>
                            <Table.HeaderCell collapsing colSpan="2">Commanders (victories)</Table.HeaderCell>
                        </Table.Row>
                    </Table.Header>
                    <Table.Body>
                        {body.comm_wins.map((c: any) => (
                            <Table.Row>
